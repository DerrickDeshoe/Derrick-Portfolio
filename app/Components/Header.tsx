...
const NavBar = () => {
  ...
  return (
      ...
      <div className=" header flex flex-col space-y-3 lg:space-y-0 items-center space-x-2 px-10 py-5 lg:flex-row justify-between w-[100%] text-white bg-transparent absolute top-0">
